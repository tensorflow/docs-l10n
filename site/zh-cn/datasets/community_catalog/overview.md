...
- app_reviews（[代码](https://github.com/huggingface/datasets/blob/master/datasets/app_reviews)/[Huggingface](https://huggingface.co/datasets/app_reviews)）
...
- bing_coronavirus_query_set（[代码](https://github.com/huggingface/datasets/blob/master/datasets/bing_coronavirus_query_set)/[Huggingface](https://huggingface.co/datasets/bing_coronavirus_query_set)）
...
- cfq（[代码](https://github.com/huggingface/datasets/blob/master/datasets/cfq)/[Huggingface](https://huggingface.co/datasets/cfq)）
...
- code_x_glue_tc_nl_code_search_adv（[代码](https://github.com/huggingface/datasets/blob/master/datasets/code_x_glue_tc_nl_code_search_adv)/[Huggingface](https://huggingface.co/datasets/code_x_glue_tc_nl_code_search_adv)）
...
- craigslist_bargains（[代码](https://github.com/huggingface/datasets/blob/master/datasets/craigslist_bargains)/[Huggingface](https://huggingface.co/datasets/craigslist_bargains)）
...
- dutch_social（[代码](https://github.com/huggingface/datasets/blob/master/datasets/dutch_social)/[Huggingface](https://huggingface.co/datasets/dutch_social)）
...
- fake_news_filipino（[代码](https://github.com/huggingface/datasets/blob/master/datasets/fake_news_filipino)/[Huggingface](https://huggingface.co/datasets/fake_news_filipino)）
...
- gutenberg_time（[代码](https://github.com/huggingface/datasets/blob/master/datasets/gutenberg_time)/[Huggingface](https://huggingface.co/datasets/gutenberg_time)）
...
- hrwac（[代码](https://github.com/huggingface/datasets/blob/master/datasets/hrwac)/[Huggingface](https://huggingface.co/datasets/hrwac)）
...
- jigsaw_toxicity_pred（[代码](https://github.com/huggingface/datasets/blob/master/datasets/jigsaw_toxicity_pred)/[Huggingface](https://huggingface.co/datasets/jigsaw_toxicity_pred)）
...
- limit（[代码](https://github.com/huggingface/datasets/blob/master/datasets/limit)/[Huggingface](https://huggingface.co/datasets/limit)）
...
- mnist（[代码](https://github.com/huggingface/datasets/blob/master/datasets/mnist)/[Huggingface](https://huggingface.co/datasets/mnist)）
...
- ncbi_disease（[代码](https://github.com/huggingface/datasets/blob/master/datasets/ncbi_disease)/[Huggingface](https://huggingface.co/datasets/ncbi_disease)）
...
- openai_humaneval（[代码](https://github.com/huggingface/datasets/blob/master/datasets/openai_humaneval)/[Huggingface](https://huggingface.co/datasets/openai_humaneval)）
...
- pec（[代码](https://github.com/huggingface/datasets/blob/master/datasets/pec)/[Huggingface](https://huggingface.co/datasets/pec)）
...
- qed（[代码](https://github.com/huggingface/datasets/blob/master/datasets/qed)/[Huggingface](https://huggingface.co/datasets/qed)）
...
- scb_mt_enth_2020（[代码](https://github.com/huggingface/datasets/blob/master/datasets/scb_mt_enth_2020)/[Huggingface](https://huggingface.co/datasets/scb_mt_enth_2020)）
...
- silicone（[代码](https://github.com/huggingface/datasets/blob/master/datasets/silicone)/[Huggingface](https://huggingface.co/datasets/silicone)）
- simple_questions_v2（[代码](https://github.com/huggingface/datasets/blob/master/datasets/simple_questions_v2)/[Huggingface](https://huggingface.co/datasets/simple_questions_v2)）
- siswati_ner_corpus（[代码](https://github.com/huggingface/datasets/blob/master/datasets/siswati_ner_corpus)/[Huggingface](https://huggingface.co/datasets/siswati_ner_corpus)）
- smartdata（[代码](https://github.com/huggingface/datasets/blob/master/datasets/smartdata)/[Huggingface](https://huggingface.co/datasets/smartdata)）
- sms_spam（[代码](https://github.com/huggingface/datasets/blob/master/datasets/sms_spam)/[Huggingface](https://huggingface.co/datasets/sms_spam)）
- snips_built_in_intents（[代码](https://github.com/huggingface/datasets/blob/master/datasets/snips_built_in_intents)/[Huggingface](https://huggingface.co/datasets/snips_built_in_intents)）
- snli（[代码](https://github.com/huggingface/datasets/blob/master/datasets/snli)/[Huggingface](https://huggingface.co/datasets/snli)）
- snow_simplified_japanese_corpus（[代码](https://github.com/huggingface/datasets/blob/master/datasets/snow_simplified_japanese_corpus)/[Huggingface](https://huggingface.co/datasets/snow_simplified_japanese_corpus)）
- so_stacksample（[代码](https://github.com/huggingface/datasets/blob/master/datasets/so_stacksample)/[Huggingface](https://huggingface.co/datasets/so_stacksample)）
- social_bias_frames（[代码](https://github.com/huggingface/datasets/blob/master/datasets/social_bias_frames)/[Huggingface](https://huggingface.co/datasets/social_bias_frames)）
- social_i_qa（[代码](https://github.com/huggingface/datasets/blob/master/datasets/social_i_qa)/[Huggingface](https://huggingface.co/datasets/social_i_qa)）
- sofc_materials_articles（[代码](https://github.com/huggingface/datasets/blob/master/datasets/sofc_materials_articles)/[Huggingface](https://huggingface.co/datasets/sofc_materials_articles)）
- sogou_news（[代码](https://github.com/huggingface/datasets/blob/master/datasets/sogou_news)/[Huggingface](https://huggingface.co/datasets/sogou_news)）
- spanish_billion_words（[代码](https://github.com/huggingface/datasets/blob/master/datasets/spanish_billion_words)/[Huggingface](https://huggingface.co/datasets/spanish_billion_words)）
- spc（[代码](https://github.com/huggingface/datasets/blob/master/datasets/spc)/[Huggingface](https://huggingface.co/datasets/spc)）
- species_800（[代码](https://github.com/huggingface/datasets/blob/master/datasets/species_800)/[Huggingface](https://huggingface.co/datasets/species_800)）
- speech_commands（[代码](https://github.com/huggingface/datasets/blob/master/datasets/speech_commands)/[Huggingface](https://huggingface.co/datasets/speech_commands)）
- spider（[代码](https://github.com/huggingface/datasets/blob/master/datasets/spider)/[Huggingface](https://huggingface.co/datasets/spider)）
- squad（[代码](https://github.com/huggingface/datasets/blob/master/datasets/squad)/[Huggingface](https://huggingface.co/datasets/squad)）
- squad_adversarial（[代码](https://github.com/huggingface/datasets/blob/master/datasets/squad_adversarial)/[Huggingface](https://huggingface.co/datasets/squad_adversarial)）
- squad_es（[代码](https://github.com/huggingface/datasets/blob/master/datasets/squad_es)/[Huggingface](https://huggingface.co/datasets/squad_es)）
- squad_it（[代码](https://github.com/huggingface/datasets/blob/master/datasets/squad_it)/[Huggingface](https://huggingface.co/datasets/squad_it)）
- squad_kor_v1（[代码](https://github.com/huggingface/datasets/blob/master/datasets/squad_kor_v1)/[Huggingface](https://huggingface.co/datasets/squad_kor_v1)）
- squad_kor_v2（[代码](https://github.com/huggingface/datasets/blob/master/datasets/squad_kor_v2)/[Huggingface](https://huggingface.co/datasets/squad_kor_v2)）
- squad_v1_pt（[代码](https://github.com/huggingface/datasets/blob/master/datasets/squad_v1_pt)/[Huggingface](https://huggingface.co/datasets/squad_v1_pt)）
- squad_v2（[代码](https://github.com/huggingface/datasets/blob/master/datasets/squad_v2)/[Huggingface](https://huggingface.co/datasets/squad_v2)）
- squadshifts（[代码](https://github.com/huggingface/datasets/blob/master/datasets/squadshifts)/[Huggingface](https://huggingface.co/datasets/squadshifts)）
- srwac（[代码](https://github.com/huggingface/datasets/blob/master/datasets/srwac)/[Huggingface](https://huggingface.co/datasets/srwac)）
- sst（[代码](https://github.com/huggingface/datasets/blob/master/datasets/sst)/[Huggingface](https://huggingface.co/datasets/sst)）
- stereoset（[代码](https://github.com/huggingface/datasets/blob/master/datasets/stereoset)/[Huggingface](https://huggingface.co/datasets/stereoset)）
- story_cloze（[代码](https://github.com/huggingface/datasets/blob/master/datasets/story_cloze)/[Huggingface](https://huggingface.co/datasets/story_cloze)）
- stsb_mt_sv（[代码](https://github.com/huggingface/datasets/blob/master/datasets/stsb_mt_sv)/[Huggingface](https://huggingface.co/datasets/stsb_mt_sv)）
- stsb_multi_mt（[代码](https://github.com/huggingface/datasets/blob/master/datasets/stsb_multi_mt)/[Huggingface](https://huggingface.co/datasets/stsb_multi_mt)）
- style_change_detection（[代码](https://github.com/huggingface/datasets/blob/master/datasets/style_change_detection)/[Huggingface](https://huggingface.co/datasets/style_change_detection)）
- subjqa（[代码](https://github.com/huggingface/datasets/blob/master/datasets/subjqa)/[Huggingface](https://huggingface.co/datasets/subjqa)）
- super_glue（[代码](https://github.com/huggingface/datasets/blob/master/datasets/super_glue)/[Huggingface](https://huggingface.co/datasets/super_glue)）
- superb（[代码](https://github.com/huggingface/datasets/blob/master/datasets/superb)/[Huggingface](https://huggingface.co/datasets/superb)）
- swag（[代码](https://github.com/huggingface/datasets/blob/master/datasets/swag)/[Huggingface](https://huggingface.co/datasets/swag)）
- swahili（[代码](https://github.com/huggingface/datasets/blob/master/datasets/swahili)/[Huggingface](https://huggingface.co/datasets/swahili)）
- swahili_news（[代码](https://github.com/huggingface/datasets/blob/master/datasets/swahili_news)/[Huggingface](https://huggingface.co/datasets/swahili_news)）
- swda（[代码](https://github.com/huggingface/datasets/blob/master/datasets/swda)/[Huggingface](https://huggingface.co/datasets/swda)）
- swedish_medical_ner（[代码](https://github.com/huggingface/datasets/blob/master/datasets/swedish_medical_ner)/[Huggingface](https://huggingface.co/datasets/swedish_medical_ner)）
- swedish_ner_corpus（[代码](https://github.com/huggingface/datasets/blob/master/datasets/swedish_ner_corpus)/[Huggingface](https://huggingface.co/datasets/swedish_ner_corpus)）
- swedish_reviews（[代码](https://github.com/huggingface/datasets/blob/master/datasets/swedish_reviews)/[Huggingface](https://huggingface.co/datasets/swedish_reviews)）
- swiss_judgment_prediction（[代码](https://github.com/huggingface/datasets/blob/master/datasets/swiss_judgment_prediction)/[Huggingface](https://huggingface.co/datasets/swiss_judgment_prediction)）
- tab_fact（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tab_fact)/[Huggingface](https://huggingface.co/datasets/tab_fact)）
- tamilmixsentiment（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tamilmixsentiment)/[Huggingface](https://huggingface.co/datasets/tamilmixsentiment)）
- tanzil（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tanzil)/[Huggingface](https://huggingface.co/datasets/tanzil)）
- tapaco（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tapaco)/[Huggingface](https://huggingface.co/datasets/tapaco)）
- tashkeela（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tashkeela)/[Huggingface](https://huggingface.co/datasets/tashkeela)）
- taskmaster1（[代码](https://github.com/huggingface/datasets/blob/master/datasets/taskmaster1)/[Huggingface](https://huggingface.co/datasets/taskmaster1)）
- taskmaster2（[代码](https://github.com/huggingface/datasets/blob/master/datasets/taskmaster2)/[Huggingface](https://huggingface.co/datasets/taskmaster2)）
- taskmaster3（[代码](https://github.com/huggingface/datasets/blob/master/datasets/taskmaster3)/[Huggingface](https://huggingface.co/datasets/taskmaster3)）
- tatoeba（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tatoeba)/[Huggingface](https://huggingface.co/datasets/tatoeba)）
- ted_hrlr（[代码](https://github.com/huggingface/datasets/blob/master/datasets/ted_hrlr)/[Huggingface](https://huggingface.co/datasets/ted_hrlr)）
- ted_iwlst2013（[代码](https://github.com/huggingface/datasets/blob/master/datasets/ted_iwlst2013)/[Huggingface](https://huggingface.co/datasets/ted_iwlst2013)）
- ted_multi（[代码](https://github.com/huggingface/datasets/blob/master/datasets/ted_multi)/[Huggingface](https://huggingface.co/datasets/ted_multi)）
- ted_talks_iwslt（[代码](https://github.com/huggingface/datasets/blob/master/datasets/ted_talks_iwslt)/[Huggingface](https://huggingface.co/datasets/ted_talks_iwslt)）
- telugu_books（[代码](https://github.com/huggingface/datasets/blob/master/datasets/telugu_books)/[Huggingface](https://huggingface.co/datasets/telugu_books)）
- telugu_news（[代码](https://github.com/huggingface/datasets/blob/master/datasets/telugu_news)/[Huggingface](https://huggingface.co/datasets/telugu_news)）
- tep_en_fa_para（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tep_en_fa_para)/[Huggingface](https://huggingface.co/datasets/tep_en_fa_para)）
- thai_toxicity_tweet（[代码](https://github.com/huggingface/datasets/blob/master/datasets/thai_toxicity_tweet)/[Huggingface](https://huggingface.co/datasets/thai_toxicity_tweet)）
- thainer（[代码](https://github.com/huggingface/datasets/blob/master/datasets/thainer)/[Huggingface](https://huggingface.co/datasets/thainer)）
- thaiqa_squad（[代码](https://github.com/huggingface/datasets/blob/master/datasets/thaiqa_squad)/[Huggingface](https://huggingface.co/datasets/thaiqa_squad)）
- thaisum（[代码](https://github.com/huggingface/datasets/blob/master/datasets/thaisum)/[Huggingface](https://huggingface.co/datasets/thaisum)）
- the_pile（[代码](https://github.com/huggingface/datasets/blob/master/datasets/the_pile)/[Huggingface](https://huggingface.co/datasets/the_pile)）
- the_pile_books3（[代码](https://github.com/huggingface/datasets/blob/master/datasets/the_pile_books3)/[Huggingface](https://huggingface.co/datasets/the_pile_books3)）
- the_pile_openwebtext2（[代码](https://github.com/huggingface/datasets/blob/master/datasets/the_pile_openwebtext2)/[Huggingface](https://huggingface.co/datasets/the_pile_openwebtext2)）
- the_pile_stack_exchange（[代码](https://github.com/huggingface/datasets/blob/master/datasets/the_pile_stack_exchange)/[Huggingface](https://huggingface.co/datasets/the_pile_stack_exchange)）
- tilde_model（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tilde_model)/[Huggingface](https://huggingface.co/datasets/tilde_model)）
- time_dial（[代码](https://github.com/huggingface/datasets/blob/master/datasets/time_dial)/[Huggingface](https://huggingface.co/datasets/time_dial)）
- times_of_india_news_headlines（[代码](https://github.com/huggingface/datasets/blob/master/datasets/times_of_india_news_headlines)/[Huggingface](https://huggingface.co/datasets/times_of_india_news_headlines)）
- timit_asr（[代码](https://github.com/huggingface/datasets/blob/master/datasets/timit_asr)/[Huggingface](https://huggingface.co/datasets/timit_asr)）
- tiny_shakespeare（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tiny_shakespeare)/[Huggingface](https://huggingface.co/datasets/tiny_shakespeare)）
- tlc（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tlc)/[Huggingface](https://huggingface.co/datasets/tlc)）
- tmu_gfm_dataset（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tmu_gfm_dataset)/[Huggingface](https://huggingface.co/datasets/tmu_gfm_dataset)）
- totto（[代码](https://github.com/huggingface/datasets/blob/master/datasets/totto)/[Huggingface](https://huggingface.co/datasets/totto)）
- trec（[代码](https://github.com/huggingface/datasets/blob/master/datasets/trec)/[Huggingface](https://huggingface.co/datasets/trec)）
- trivia_qa（[代码](https://github.com/huggingface/datasets/blob/master/datasets/trivia_qa)/[Huggingface](https://huggingface.co/datasets/trivia_qa)）
- tsac（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tsac)/[Huggingface](https://huggingface.co/datasets/tsac)）
- ttc4900（[代码](https://github.com/huggingface/datasets/blob/master/datasets/ttc4900)/[Huggingface](https://huggingface.co/datasets/ttc4900)）
- tunizi（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tunizi)/[Huggingface](https://huggingface.co/datasets/tunizi)）
- tuple_ie（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tuple_ie)/[Huggingface](https://huggingface.co/datasets/tuple_ie)）
- turk（[代码](https://github.com/huggingface/datasets/blob/master/datasets/turk)/[Huggingface](https://huggingface.co/datasets/turk)）
- turkish_movie_sentiment（[代码](https://github.com/huggingface/datasets/blob/master/datasets/turkish_movie_sentiment)/[Huggingface](https://huggingface.co/datasets/turkish_movie_sentiment)）
- turkish_ner（[代码](https://github.com/huggingface/datasets/blob/master/datasets/turkish_ner)/[Huggingface](https://huggingface.co/datasets/turkish_ner)）
- turkish_product_reviews（[代码](https://github.com/huggingface/datasets/blob/master/datasets/turkish_product_reviews)/[Huggingface](https://huggingface.co/datasets/turkish_product_reviews)）
- turkish_shrinked_ner（[代码](https://github.com/huggingface/datasets/blob/master/datasets/turkish_shrinked_ner)/[Huggingface](https://huggingface.co/datasets/turkish_shrinked_ner)）
- turku_ner_corpus（[代码](https://github.com/huggingface/datasets/blob/master/datasets/turku_ner_corpus)/[Huggingface](https://huggingface.co/datasets/turku_ner_corpus)）
- tweet_eval（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tweet_eval)/[Huggingface](https://huggingface.co/datasets/tweet_eval)）
- tweet_qa（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tweet_qa)/[Huggingface](https://huggingface.co/datasets/tweet_qa)）
- tweets_ar_en_parallel（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tweets_ar_en_parallel)/[Huggingface](https://huggingface.co/datasets/tweets_ar_en_parallel)）
- tweets_hate_speech_detection（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tweets_hate_speech_detection)/[Huggingface](https://huggingface.co/datasets/tweets_hate_speech_detection)）
- twi_text_c3（[代码](https://github.com/huggingface/datasets/blob/master/datasets/twi_text_c3)/[Huggingface](https://huggingface.co/datasets/twi_text_c3)）
- twi_wordsim353（[代码](https://github.com/huggingface/datasets/blob/master/datasets/twi_wordsim353)/[Huggingface](https://huggingface.co/datasets/twi_wordsim353)）
- tydiqa（[代码](https://github.com/huggingface/datasets/blob/master/datasets/tydiqa)/[Huggingface](https://huggingface.co/datasets/tydiqa)）
- ubuntu_dialogs_corpus（[代码](https://github.com/huggingface/datasets/blob/master/datasets/ubuntu_dialogs_corpus)/[Huggingface](https://huggingface.co/datasets/ubuntu_dialogs_corpus)）
- udhr（[代码](https://github.com/huggingface/datasets/blob/master/datasets/udhr)/[Huggingface](https://huggingface.co/datasets/udhr)）
- um005（[代码](https://github.com/huggingface/datasets/blob/master/datasets/um005)/[Huggingface](https://huggingface.co/datasets/um005)）
- un_ga（[代码](https://github.com/huggingface/datasets/blob/master/datasets/un_ga)/[Huggingface](https://huggingface.co/datasets/un_ga)）
- un_multi（[代码](https://github.com/huggingface/datasets/blob/master/datasets/un_multi)/[Huggingface](https://huggingface.co/datasets/un_multi)）
- un_pc（[代码](https://github.com/huggingface/datasets/blob/master/datasets/un_pc)/[Huggingface](https://huggingface.co/datasets/un_pc)）
- universal_dependencies（[代码](https://github.com/huggingface/datasets/blob/master/datasets/universal_dependencies)/[Huggingface](https://huggingface.co/datasets/universal_dependencies)）
- universal_morphologies（[代码](https://github.com/huggingface/datasets/blob/master/datasets/universal_morphologies)/[Huggingface](https://huggingface.co/datasets/universal_morphologies)）
- urdu_fake_news（[代码](https://github.com/huggingface/datasets/blob/master/datasets/urdu_fake_news)/[Huggingface](https://huggingface.co/datasets/urdu_fake_news)）
- urdu_sentiment_corpus（[代码](https://github.com/huggingface/datasets/blob/master/datasets/urdu_sentiment_corpus)/[Huggingface](https://huggingface.co/datasets/urdu_sentiment_corpus)）
- vivos（[代码](https://github.com/huggingface/datasets/blob/master/datasets/vivos)/[Huggingface](https://huggingface.co/datasets/vivos)）
- web_nlg（[代码](https://github.com/huggingface/datasets/blob/master/datasets/web_nlg)/[Huggingface](https://huggingface.co/datasets/web_nlg)）
- web_of_science（[代码](https://github.com/huggingface/datasets/blob/master/datasets/web_of_science)/[Huggingface](https://huggingface.co/datasets/web_of_science)）
- web_questions（[代码](https://github.com/huggingface/datasets/blob/master/datasets/web_questions)/[Huggingface](https://huggingface.co/datasets/web_questions)）
- weibo_ner（[代码](https://github.com/huggingface/datasets/blob/master/datasets/weibo_ner)/[Huggingface](https://huggingface.co/datasets/weibo_ner)）
- wi_locness（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wi_locness)/[Huggingface](https://huggingface.co/datasets/wi_locness)）
- wiki40b（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki40b)/[Huggingface](https://huggingface.co/datasets/wiki40b)）
- wiki_asp（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_asp)/[Huggingface](https://huggingface.co/datasets/wiki_asp)）
- wiki_atomic_edits（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_atomic_edits)/[Huggingface](https://huggingface.co/datasets/wiki_atomic_edits)）
- wiki_auto（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_auto)/[Huggingface](https://huggingface.co/datasets/wiki_auto)）
- wiki_bio（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_bio)/[Huggingface](https://huggingface.co/datasets/wiki_bio)）
- wiki_dpr（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_dpr)/[Huggingface](https://huggingface.co/datasets/wiki_dpr)）
- wiki_hop（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_hop)/[Huggingface](https://huggingface.co/datasets/wiki_hop)）
- wiki_lingua（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_lingua)/[Huggingface](https://huggingface.co/datasets/wiki_lingua)）
- wiki_movies（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_movies)/[Huggingface](https://huggingface.co/datasets/wiki_movies)）
- wiki_qa（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_qa)/[Huggingface](https://huggingface.co/datasets/wiki_qa)）
- wiki_qa_ar（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_qa_ar)/[Huggingface](https://huggingface.co/datasets/wiki_qa_ar)）
- wiki_snippets（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_snippets)/[Huggingface](https://huggingface.co/datasets/wiki_snippets)）
- wiki_source（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_source)/[Huggingface](https://huggingface.co/datasets/wiki_source)）
- wiki_split（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_split)/[Huggingface](https://huggingface.co/datasets/wiki_split)）
- wiki_summary（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiki_summary)/[Huggingface](https://huggingface.co/datasets/wiki_summary)）
- wikiann（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wikiann)/[Huggingface](https://huggingface.co/datasets/wikiann)）
- wikicorpus（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wikicorpus)/[Huggingface](https://huggingface.co/datasets/wikicorpus)）
- wikihow（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wikihow)/[Huggingface](https://huggingface.co/datasets/wikihow)）
- wikipedia（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wikipedia)/[Huggingface](https://huggingface.co/datasets/wikipedia)）
- wikisql（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wikisql)/[Huggingface](https://huggingface.co/datasets/wikisql)）
- wikitext（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wikitext)/[Huggingface](https://huggingface.co/datasets/wikitext)）
- wikitext_tl39（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wikitext_tl39)/[Huggingface](https://huggingface.co/datasets/wikitext_tl39)）
- wili_2018（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wili_2018)/[Huggingface](https://huggingface.co/datasets/wili_2018)）
- wino_bias（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wino_bias)/[Huggingface](https://huggingface.co/datasets/wino_bias)）
- winograd_wsc（[代码](https://github.com/huggingface/datasets/blob/master/datasets/winograd_wsc)/[Huggingface](https://huggingface.co/datasets/winograd_wsc)）
- winogrande（[代码](https://github.com/huggingface/datasets/blob/master/datasets/winogrande)/[Huggingface](https://huggingface.co/datasets/winogrande)）
- wiqa（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wiqa)/[Huggingface](https://huggingface.co/datasets/wiqa)）
- wisesight1000（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wisesight1000)/[Huggingface](https://huggingface.co/datasets/wisesight1000)）
- wisesight_sentiment（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wisesight_sentiment)/[Huggingface](https://huggingface.co/datasets/wisesight_sentiment)）
- wmt14（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wmt14)/[Huggingface](https://huggingface.co/datasets/wmt14)）
- wmt15（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wmt15)/[Huggingface](https://huggingface.co/datasets/wmt15)）
- wmt16（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wmt16)/[Huggingface](https://huggingface.co/datasets/wmt16)）
- wmt17（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wmt17)/[Huggingface](https://huggingface.co/datasets/wmt17)）
- wmt18（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wmt18)/[Huggingface](https://huggingface.co/datasets/wmt18)）
- wmt19（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wmt19)/[Huggingface](https://huggingface.co/datasets/wmt19)）
- wmt20_mlqe_task1（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wmt20_mlqe_task1)/[Huggingface](https://huggingface.co/datasets/wmt20_mlqe_task1)）
- wmt20_mlqe_task2（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wmt20_mlqe_task2)/[Huggingface](https://huggingface.co/datasets/wmt20_mlqe_task2)）
- wmt20_mlqe_task3（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wmt20_mlqe_task3)/[Huggingface](https://huggingface.co/datasets/wmt20_mlqe_task3)）
- wmt_t2t（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wmt_t2t)/[Huggingface](https://huggingface.co/datasets/wmt_t2t)）
- wnut_17（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wnut_17)/[Huggingface](https://huggingface.co/datasets/wnut_17)）
- wongnai_reviews（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wongnai_reviews)/[Huggingface](https://huggingface.co/datasets/wongnai_reviews)）
- woz_dialogue（[代码](https://github.com/huggingface/datasets/blob/master/datasets/woz_dialogue)/[Huggingface](https://huggingface.co/datasets/woz_dialogue)）
- wrbsc（[代码](https://github.com/huggingface/datasets/blob/master/datasets/wrbsc)/[Huggingface](https://huggingface.co/datasets/wrbsc)）
- x_stance（[代码](https://github.com/huggingface/datasets/blob/master/datasets/x_stance)/[Huggingface](https://huggingface.co/datasets/x_stance)）
- xcopa（[代码](https://github.com/huggingface/datasets/blob/master/datasets/xcopa)/[Huggingface](https://huggingface.co/datasets/xcopa)）
- xcsr（[代码](https://github.com/huggingface/datasets/blob/master/datasets/xcsr)/[Huggingface](https://huggingface.co/datasets/xcsr)）
- xed_en_fi（[代码](https://github.com/huggingface/datasets/blob/master/datasets/xed_en_fi)/[Huggingface](https://huggingface.co/datasets/xed_en_fi)）
- xglue（[代码](https://github.com/huggingface/datasets/blob/master/datasets/xglue)/[Huggingface](https://huggingface.co/datasets/xglue)）
- xnli（[代码](https://github.com/huggingface/datasets/blob/master/datasets/xnli)/[Huggingface](https://huggingface.co/datasets/xnli)）
- xor_tydi_qa（[代码](https://github.com/huggingface/datasets/blob/master/datasets/xor_tydi_qa)/[Huggingface](https://huggingface.co/datasets/xor_tydi_qa)）
- xquad（[代码](https://github.com/huggingface/datasets/blob/master/datasets/xquad)/[Huggingface](https://huggingface.co/datasets/xquad)）
- xquad_r（[代码](https://github.com/huggingface/datasets/blob/master/datasets/xquad_r)/[Huggingface](https://huggingface.co/datasets/xquad_r)）
- xsum（[代码](https://github.com/huggingface/datasets/blob/master/datasets/xsum)/[Huggingface](https://huggingface.co/datasets/xsum)）
- xsum_factuality（[代码](https://github.com/huggingface/datasets/blob/master/datasets/xsum_factuality)/[Huggingface](https://huggingface.co/datasets/xsum_factuality)）
- xtreme（[代码](https://github.com/huggingface/datasets/blob/master/datasets/xtreme)/[Huggingface](https://huggingface.co/datasets/xtreme)）
- yahoo_answers_qa（[代码](https://github.com/huggingface/datasets/blob/master/datasets/yahoo_answers_qa)/[Huggingface](https://huggingface.co/datasets/yahoo_answers_qa)）
- yahoo_answers_topics（[代码](https://github.com/huggingface/datasets/blob/master/datasets/yahoo_answers_topics)/[Huggingface](https://huggingface.co/datasets/yahoo_answers_topics)）
- yelp_polarity（[代码](https://github.com/huggingface/datasets/blob/master/datasets/yelp_polarity)/[Huggingface](https://huggingface.co/datasets/yelp_polarity)）
- yelp_review_full（[代码](https://github.com/huggingface/datasets/blob/master/datasets/yelp_review_full)/[Huggingface](https://huggingface.co/datasets/yelp_review_full)）
- yoruba_bbc_topics（[代码](https://github.com/huggingface/datasets/blob/master/datasets/yoruba_bbc_topics)/[Huggingface](https://huggingface.co/datasets/yoruba_bbc_topics)）
- yoruba_gv_ner（[代码](https://github.com/huggingface/datasets/blob/master/datasets/yoruba_gv_ner)/[Huggingface](https://huggingface.co/datasets/yoruba_gv_ner)）
- yoruba_text_c3（[代码](https://github.com/huggingface/datasets/blob/master/datasets/yoruba_text_c3)/[Huggingface](https://huggingface.co/datasets/yoruba_text_c3)）
- yoruba_wordsim353（[代码](https://github.com/huggingface/datasets/blob/master/datasets/yoruba_wordsim353)/[Huggingface](https://huggingface.co/datasets/yoruba_wordsim353)）
- youtube_caption_corrections（[代码](https://github.com/huggingface/datasets/blob/master/datasets/youtube_caption_corrections)/[Huggingface](https://huggingface.co/datasets/youtube_caption_corrections)）
- zest（[代码](https://github.com/huggingface/datasets/blob/master/datasets/zest)/[Huggingface](https://huggingface.co/datasets/zest)）
