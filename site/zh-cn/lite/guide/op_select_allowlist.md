...
您还可以从源代码创建自己的拉取请求。例如，如果您想要在允许列表中添加 `raw_ops.StringToNumber` 算子，则有三个地方可以像此[提交](https://github.com/tensorflow/tensorflow/commit/02e691329517eb5e76522ed8d8bef79ceb082ff8)一样更新。
