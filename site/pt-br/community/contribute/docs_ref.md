...
## Docstrings testáveis

O TensorFlow usa [DocTest](https://docs.python.org/3/library/doctest.html) para testar trechos de código em docstrings Python. O trecho deve ser um código Python executável. Para ativar o teste, acrescente a linha com `>>>` (três sinais de maior). Por exemplo, aqui está um trecho da função `tf.concat` do arquivo-fonte [array_ops.py](https://www.tensorflow.org/code/tensorflow/python/ops/array_ops.py):
