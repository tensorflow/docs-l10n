...
소스 코드에서 고유한 풀 리퀘스트를 만들 수도 있습니다. 예를 들어, 허용 목록에 `raw_ops.StringToNumber`을 추가하려는 경우 이 [커밋](https://github.com/tensorflow/tensorflow/commit/02e691329517eb5e76522ed8d8bef79ceb082ff8)과 같이 업데이트할 위치가 세 곳 있습니다.
