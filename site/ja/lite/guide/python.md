...
&lt;code class="devsite-terminal"&gt;curl https://packages.cloud.google.com/apt/doc/apt-key.gpg | sudo apt-key add -
&lt;/code&gt;&lt;code class="devsite-terminal"&gt;sudo apt-get update
&lt;/code&gt;&lt;code class="devsite-terminal"&gt;sudo apt-get install python3-tflite-runtime&lt;/code&gt;
</pre>
