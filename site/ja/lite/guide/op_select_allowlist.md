...
また、ソースコードから独自のプル要求を作成することもできます。たとえば、許可リストで `raw_ops.StringToNumber` 演算子を追加する場合は、次の [commit](https://github.com/tensorflow/tensorflow/commit/02e691329517eb5e76522ed8d8bef79ceb082ff8) のように 3 箇所で更新する必要があります。
