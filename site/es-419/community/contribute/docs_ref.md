# Cómo contribuir a la documentación de la API de TensorFlow

<a id="doctest"></a>

## Cadenas de documentación comprobables

TensorFlow usa [DocTest](https://docs.python.org/3/library/doctest.html) para probar fragmentos de código en cadenas de documentación de Python. El fragmento debe ser código Python ejecutable. Para habilitar la prueba, escriba `>>>` (tres corchetes en ángulo izquierdo) antes de la línea. Por ejemplo, aquí hay un extracto de la función `tf.concat` en el archivo fuente [array_ops.py](https://www.tensorflow.org/code/tensorflow/python/ops/array_ops.py):
